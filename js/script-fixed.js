...
// DISABLED: Comment out to prevent auto-scroll on page load
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize animations - SCROLL ANIMATIONS DISABLED TO PREVENT AUTO-SCROLL
    // revealElements();              // DISABLED
    // animateCounters();             // DISABLED
    // parallaxEffect();              // DISABLED: Images will no longer move on scroll
    hoverLiftEffect();               // ENABLED: Hover effects still work
    // animateTextOnScroll();         // DISABLED
    // animateGradientText();         // DISABLED
});
...
console.log('✅ Stackly Script Ready! (Auto-scroll disabled)');
